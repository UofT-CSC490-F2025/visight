...
class VideoProcessor:
    ...
    def extract_frames(self, video_path: str, output_dir: str) -> List[dict]:
        ...
        try:
            ...
            while True:
                ...
                if frame_count % frame_interval == 0:
                    ...
                    cv2.imwrite(str(frame_path), frame, [
                                cv2.IMWRITE_JPEG_QUALITY, 85, cv2.IMWRITE_JPEG_OPTIMIZE, 1])  # OPTIMIZATION - Use optimized JPEG saving + optimize flag

                    frame_id = hashlib.sha256(
                        f"{video_path}_{frame_count}".encode()).hexdigest()
            ...
            print(
                f"Extracted {extracted_count} frames from {total_frames} total frames")
            ...
            profile_file = profile_output_dir / \
                f"extract_frames_{timestamp}.txt"
